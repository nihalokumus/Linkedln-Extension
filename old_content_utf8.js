        ...
        if (nestedUl) {
            ...
            subItems.forEach(subItem => {
                ...
                experiences.push({
                    company: companyName,
                    position: subSpans[0] || "",
                    duration: subSpans.find(t => t.includes(" ΓÇô ") || t.includes("-")) || "",
            ...
            experiences.push({
                position: spans[0] || "",
                company: spans[1] || "",
                duration: spans.find(t => t.includes(" ΓÇô ") || t.includes("-")) || "",
...
function getEducation() {
    const section = getSectionByHeader("Education") || getSectionByHeader("E─ƒitim");
    if (!section) return [];
    ...
    return items.map(item => {
        ...
        return {
            institution: lines[0] || "",
            degree: lines[1] || "",
            duration: lines.find(t => t.includes(" ΓÇô ") || t.includes("-")) || "",
        };
